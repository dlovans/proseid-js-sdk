const dictionaries = {
	...
	sv: {
		...
		guidedReviewCue: 'Granska det sista svaret och kontrollera sedan hela vägen.',
		back: 'Tillbaka',
		continue: 'Fortsätt',
		...
		determinationHelp: 'Det preliminära resultatet uppdateras automatiskt när uppgifterna ändras. Ingenting registreras förrän du bekräftar.',
		...
		determinationPreparing: 'Förbereder resultatet…',
